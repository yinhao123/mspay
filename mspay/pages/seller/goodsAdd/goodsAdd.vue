	...
	<view>
		...
		<form>
			...
			<view class="cu-form-group align-start">
				...
				<textarea maxlength="-1" :disabled="modalName!=null" @input="textareaBInput" placeholder="公开内容,任何人可见"></textarea>
			</view>
			
			<view class="cu-form-group align-start">
				<view class="title">隐藏内容</view>
				<textarea maxlength="-1" :disabled="modalName!=null" @input="textareaBInput" placeholder="隐藏内容,付费后可见"></textarea>
			</view>
			
			<view class="cu-form-group margin-top">
				<view class="title">同意推荐</view>
